...
__kernel void ebc(
    ...
    if ( region_north(j,k)||region_east(j,k) ){
        ...
        u[id(2,j,k)] =+cos((k2x*j+k2y*k)*dx-k2z0-w2*thestep*dt)/cosh((k1x*j+k1y*k)*dx-k1z0-2*w1*thestep*dt);
        v[id(2,j,k)] =-sin((k2x*j+k2y*k)*dx-k2z0-w2*thestep*dt)/cosh((k1x*j+k1y*k)*dx-k1z0-2*w1*thestep*dt);

        u[id(3,j,k)] =+cos((k2x*j+k2y*k)*dx-k2z0-w2*(thestep+1)*dt)/cosh((k1x*j+k1y*k)*dx-k1z0-w1*(2*thestep+1)*dt);
        v[id(3,j,k)] =-sin((k2x*j+k2y*k)*dx-k2z0-w2*(thestep+1)*dt)/cosh((k1x*j+k1y*k)*dx-k1z0-w1*(2*thestep+1)*dt);
    }
    else{
    }
    };
